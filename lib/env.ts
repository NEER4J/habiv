...
const serverSchema = z.object({
  ...
  R2_UPLOADS_BUCKET: z.string().min(1).default("habiv-uploads"),
  R2_GAMES_BUCKET: z.string().min(1).default("habiv-games"),
  R2_PUBLIC_BUCKET: z.string().min(1).default("habiv-public"),
...
/** Lazily parsed so routes that never touch R2 (health, auth) do not require R2 vars. */
